...
public class FormApiController {
    ...
    @GetMapping("/{formId}")
    public ResponseEntity<ApiResponse<FormResponseDTO>> getFormById(@PathVariable long postId, @PathVariable long formId, @AuthenticationPrincipal String username, @RequestBody FormRequestDTO requestDto){
